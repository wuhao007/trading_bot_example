...
def trade(pair, bal, api, ticker):
    ...
    while True:
        ...
        logger.info('ahr999 0.45: %s, ahr999 1.2: %s, ahr999x 0.45: %s', ahr999_045, ahr999_120, ahr999x_045)
        ...
        buy = Buy(config.BUY_LEVELS[altname], ask,
                str(int(1000 * time.time())), 'buy')
        ...
        if buy.order_size >= vol_min and ask < ahr999_120:
            ...
            if buy.price < ahr999_045: 
                ...
                stage = 1
            time.sleep(cost * _SLEEP_SECONDS[altname] * stage)
